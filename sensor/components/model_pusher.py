...
from sensor.entity.artifact_entity import  DataTransformationArtifacts, ModelTrainingArtifacts, ModelPusherArtifacts
class ModelPusher:
    ...
    def initiate_model_pusher(self):
        try:
            ...
            target_encoder_path=self.model_resolver.get_latest_save_target_encoder()

            save_object(file_path=transformer_path, obj=transformer)
            save_object(file_path=model_path, obj=model)
            save_object(file_path=target_encoder_path, obj=target_encoder)

            model_pusher_artifact = ModelPusherArtifacts(pusher_model_dir=self.model_pusher_config.pusher_model_dir,
