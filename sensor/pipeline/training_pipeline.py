...
def start_training_pipeline():
    try:
        ...
        data_transformation = DataTransformation(data_transformation_config, data_ingestion_artifacts)
        ...
        model_evaluater = ModelEvaluation(model_evaluation_config, data_ingestion_artifacts,
                                          data_transformation_artifact, model_trainer_artifact)
        model_eval_artifact = model_evaluater.initiate_model_evaluation()
